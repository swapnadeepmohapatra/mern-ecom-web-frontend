			...
			<div>
				<div className="row">
					<div className="col-12 text-left">
						{goBack()}
						<h2 className="text-center text-black my-3">Total {products.length} products</h2>

						{products.map((item, index) => {
							return (
								<div key={index} className="row text-center mb-2 d-flex justify-content-center">
									<div className="col-3">
									...
									<div className="col-3" style={{ display: 'flex', flexDirection: 'column' }}>
										<Link className="btn btn-success mb-5" to={`/admin/product/update/${item._id}`}>
